...
<head>
    ...
    <title>Register - Book Spark</title>
        ...
        <div id="auth-right"class="w-3/5 text-black grid justify-center items-center m-auto">
            <div class="bg-white shadow-2xl px-8 py-4 rounded-2xl">
                ...
                <form action="{{ route ('doregister')}}" method="POST" class="mt-8">
                    ...
                    <div class="flex flex-col mb-1">
                        <label class="text-black text-lg" for="password">Confirm Password</label>
                        <input type="password" class="text-slate-400 p-2 mt-4" name="password" placeholder="Password">
                    </div>
                    <button class="bg-seconder w-96 rounded-md p-2 mt-4 text-white font-semibold">Register</button>
                </form>
            </div>
            <div class="grid items-center justify-center mt-4">
                <p>Already have an account? <a href="/register" class="text-blue-400">Log In</a></p>
            </div>
        </div>
    </div>
